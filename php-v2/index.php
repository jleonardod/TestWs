...
<head>
    ...
    <title>An Updated PHP Application - AWS Elastic Beanstalk</title>
...
<body>
    <section class="congratulations">
        ...
        <p>This environment is launched with Elastic Beanstalk an Updated PHP Platform</p>
    </section>

    <section class="instructions">
        <h2>What's Next? is it Updated?</h2>
        <ul>
